# 24. POST https://http-intake.logs.us5.datadoghq.com/api/v2/logs

**阶段**：Telemetry **状态码**：202 **请求大小**：9180 B **响应大小**：2 B

**用途**：Datadog 第三批。4 条，含 `chrome_bridge_connection_succeeded`。新增 `tool_name/is_mcp/duration_ms/permission_duration_ms` 等字段。
...
- **Content-Type**：`application/json`
- **Content-Length**：`9180` B（解码后实际 `9180` B）
- **格式**：JSON (array[4])
...
| vcs | string | "git" |
| message_i_d | string | "msg_017e8es5qYt7pN4Sw5FBMz2N" |
| tool_name | string | "ToolSearch" |
| is_mcp | bool | false |
| duration_ms | int | 1 |
| pre_tool_hook_duration_ms | int | 1 |
| permission_duration_ms | int | 0 |
| tool_result_size_bytes | int | 81 |
| tool_input_size_bytes | int | 74 |
| query_chain_id | string | "7e688a90-53e7-42ae-9e49-b40c9ab0cb60" |
| query_depth | int | 0 |
| request_id | string | "req_011CafsZAMwtqvKYYVfqAC1C" |
| user_bucket | int | 21 |
...
| date | Sun, 03 May 2026 15:28:58 GMT |
| connection | close |
...
---
_原始 JSON_：[`rows/24-POST-http-intake.logs.us5.datadoghq.com_api_v2_logs.json`](../rows/24-POST-http-intake.logs.us5.datadoghq.com_api_v2_logs.json)
