...
**阶段**：业务 — Telemetry **状态码**：200 **请求大小**：2053 B **响应大小**：0 B
...
- **Content-Type**：`application/json`
- **Content-Length**：`2053` B（解码后实际 `2053` B）
- **格式**：JSON (object)
...
| content-length | 0 |
| connection | close |
| date | Sun, 24 May 2026 08:05:11 GMT |
| x-amzn-trace-id | Root=1-6a12b137-4331389728db4f886b713255 |
| x-amzn-requestid | b857d7ba-764b-474a-8d26-457211b25c2a |
| access-control-allow-origin | * |
| x-amz-apigw-id | d3CgwGAooAMEgNw= |
| x-cache | Miss from cloudfront |
| via | 1.1 8944ddb1c5239551b946c1ebd5be7728.cloudfront.net (CloudFront) |
| x-amz-cf-pop | JFK50-P14 |
| x-amz-cf-id | uIQsTjj8VHzzxFJuElyevhkCvPFpkloEVOaSjY20E4sH7AIdj9gCeQ== |
