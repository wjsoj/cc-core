# 32. POST https://client-telemetry.us-east-1.amazonaws.com/metrics
...
| x-amzn-trace-id | Root=1-6a12b174-524b8ec51780706357a59503 |
| x-amzn-requestid | 6bd8a441-bb0f-4f51-9669-a5a6f653ffea |
| access-control-allow-origin | * |
| x-amz-apigw-id | d3CqVGLOIAMEDmg= |
| x-cache | Miss from cloudfront |
| via | 1.1 81943ecf479423de3131481cdfd8dff8.cloudfront.net (CloudFront) |
| x-amz-cf-pop | JFK50-P14 |
| x-amz-cf-id | 2RpR8Qlx1q8toM2BSCt_2-1-nrHG7xomqWFMS6bb-ahS-DRTx-6JlQ== |
...
---
_原始 JSON_：[`rows/32-POST-client-telemetry.us-east-1.amazonaws.com_metrics.json`](../rows/32-POST-client-telemetry.us-east-1.amazonaws.com_metrics.json)
