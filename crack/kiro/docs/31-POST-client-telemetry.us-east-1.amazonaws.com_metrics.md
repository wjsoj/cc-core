# 31. POST https://client-telemetry.us-east-1.amazonaws.com/metrics

**阶段**：业务 — Telemetry **状态码**：200 **请求大小**：2302 B **响应大小**：0 B
...
- **Content-Type**：`application/json`
- **Content-Length**：`2302` B（解码后实际 `2302` B）
- **格式**：JSON (object)
...
| content-length | 0 |
| connection | close |
| date | Sun, 24 May 2026 08:06:11 GMT |
| x-amzn-trace-id | Root=1-6a12b173-0c261b3a433634a07e9f878b |
| x-amzn-requestid | c364fd66-f769-4464-9a29-b311765d9214 |
| access-control-allow-origin | * |
| x-amz-apigw-id | d3CqHEzHoAMEGrA= |
| x-cache | Miss from cloudfront |
| via | 1.1 7ea16537628f4571bb4a7f7833fc0052.cloudfront.net (CloudFront) |
| x-amz-cf-pop | JFK50-P14 |
| x-amz-cf-id | WUh5Da5EDaeKkQiePyfXRWJPkwfS9OSxVChm_l4I7qNdgMLosPGXFA== |
...
---
_原始 JSON_：[`rows/31-POST-client-telemetry.us-east-1.amazonaws.com_metrics.json`](../rows/31-POST-client-telemetry.us-east-1.amazonaws.com_metrics.json)
