# 30. POST https://q.us-east-1.amazonaws.com/

**阶段**：业务 — Turn 8 Telemetry **状态码**：200 **请求大小**：1320 B **响应大小**：2 B

**用途**：Turn 8 SendTelemetryEvent。
...
- **Content-Type**：`application/x-amz-json-1.0`
- **Content-Length**：`1320` B（解码后实际 `1320` B）
- **格式**：JSON (object)

### 顶层字段
| Field | Type | Sample |
|---|---|---|
| clientToken | string | "8bf5281f-00f7-4ab5-faba-67fc2ea9cdf9" |
...
| Header | Value |
|---|---|
| date | Sun, 24 May 2026 08:06:10 GMT |
| content-type | application/x-amz-json-1.0 |
| content-length | 2 |
| connection | close |
| x-amzn-requestid | 10c881c1-5fec-46a5-b8c4-278390e050b8 |
...
---
_原始 JSON_：[`rows/30-POST-q.us-east-1.amazonaws.com_.json`](../rows/30-POST-q.us-east-1.amazonaws.com_.json)
