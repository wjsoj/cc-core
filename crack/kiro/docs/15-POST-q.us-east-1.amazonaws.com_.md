# 15. POST https://q.us-east-1.amazonaws.com/

**阶段**：业务 — Turn 3 Telemetry **状态码**：200 **请求大小**：798 B **响应大小**：2 B

**用途**：Turn 3 SendTelemetryEvent。
...
- **Content-Type**：`application/x-amz-json-1.0`
- **Content-Length**：`798` B（解码后实际 `798` B）
- **格式**：JSON (object)

### 顶层字段
| Field | Type | Sample |
|---|---|---|
| clientToken | string | "bc732da7-49b5-48bf-af47-fd34855fdb48" |
...
| Header | Value |
|---|---|
| date | Sun, 24 May 2026 08:05:27 GMT |
| content-type | application/x-amz-json-1.0 |
| content-length | 2 |
| connection | close |
| x-amzn-requestid | 97ad8020-bb6a-41ad-af98-aa709c99a36b |
...
---
_原始 JSON_：[`rows/15-POST-q.us-east-1.amazonaws.com_.json`](../rows/15-POST-q.us-east-1.amazonaws.com_.json)
