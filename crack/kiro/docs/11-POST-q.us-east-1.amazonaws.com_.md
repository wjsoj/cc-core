# 11. POST https://q.us-east-1.amazonaws.com/

**阶段**：业务 — Turn 2 Telemetry **状态码**：200 **请求大小**：849 B **响应大小**：2 B

**用途**：Turn 2 SendTelemetryEvent。
...
- **Content-Type**：`application/x-amz-json-1.0`
- **Content-Length**：`849` B（解码后实际 `849` B）
- **格式**：JSON (object)

### 顶层字段
| Field | Type | Sample |
|---|---|---|
| clientToken | string | "bf8487fb-8e2a-4f62-d830-5143ef9dd1c4" |
...
| Header | Value |
|---|---|
| date | Sun, 24 May 2026 08:05:10 GMT |
| content-type | application/x-amz-json-1.0 |
| content-length | 2 |
| connection | close |
| x-amzn-requestid | bfe35db8-1922-4ddf-89ad-21176aff281c |
...
---
_原始 JSON_：[`rows/11-POST-q.us-east-1.amazonaws.com_.json`](../rows/11-POST-q.us-east-1.amazonaws.com_.json)
