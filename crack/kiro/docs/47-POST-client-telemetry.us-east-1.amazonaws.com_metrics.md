# 47. POST https://client-telemetry.us-east-1.amazonaws.com/metrics

**阶段**：业务 — Telemetry **状态码**：200 **请求大小**：1999 B **响应大小**：0 B
...
- **Content-Type**：`application/json`
- **Content-Length**：`1999` B（解码后实际 `1999` B）
- **格式**：JSON (object)
...
| content-length | 0 |
| connection | close |
| date | Sun, 24 May 2026 08:07:02 GMT |
| x-amzn-trace-id | Root=1-6a12b1a6-45ca94be54a15f33634c042a |
| x-amzn-requestid | 9cfcd7f8-5cb4-4425-99a6-6aadb19ee9c7 |
| access-control-allow-origin | * |
| x-amz-apigw-id | d3CyIF0MIAMEVpg= |
| x-cache | Miss from cloudfront |
| via | 1.1 59201a7dc7270c8ce228abe298dced5a.cloudfront.net (CloudFront) |
| x-amz-cf-pop | JFK50-P14 |
| x-amz-cf-id | _-yhtkHUgMt3l2MbNf508YGYQv7H0oyfrhsAvHteJmU70Kh6DAJSnQ== |
...
---
_原始 JSON_：[`rows/47-POST-client-telemetry.us-east-1.amazonaws.com_metrics.json`](../rows/47-POST-client-telemetry.us-east-1.amazonaws.com_metrics.json)
