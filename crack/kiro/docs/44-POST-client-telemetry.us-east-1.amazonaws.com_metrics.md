# 44. POST https://client-telemetry.us-east-1.amazonaws.com/metrics

**阶段**：业务 — Telemetry **状态码**：200 **请求大小**：1964 B **响应大小**：0 B
...
- **Content-Type**：`application/json`
- **Content-Length**：`1964` B（解码后实际 `1964` B）
- **格式**：JSON (object)
...
| content-length | 0 |
| connection | close |
| date | Sun, 24 May 2026 08:06:48 GMT |
| x-amzn-trace-id | Root=1-6a12b198-4a9a651135e660844834d496 |
| x-amzn-requestid | 31cf356f-f92e-4ddb-946f-17d406399674 |
| access-control-allow-origin | * |
| x-amz-apigw-id | d3Cv7HGJoAMEWHg= |
| x-cache | Miss from cloudfront |
| via | 1.1 529d72ee760a19eefeb594a42cb1f398.cloudfront.net (CloudFront) |
| x-amz-cf-pop | JFK50-P14 |
| x-amz-cf-id | 5ZwE6tYh4xU0pMdFbc067i5qXdgvUO-Xj71n1F-IANmDE8aqp26Vog== |
...
---
_原始 JSON_：[`rows/44-POST-client-telemetry.us-east-1.amazonaws.com_metrics.json`](../rows/44-POST-client-telemetry.us-east-1.amazonaws.com_metrics.json)
