# 24. POST https://q.us-east-1.amazonaws.com/

**阶段**：业务 — Turn 6 Telemetry **状态码**：200 **请求大小**：1154 B **响应大小**：2 B

**用途**：Turn 6 SendTelemetryEvent。
...
- **Content-Type**：`application/x-amz-json-1.0`
- **Content-Length**：`1154` B（解码后实际 `1154` B）
- **格式**：JSON (object)

### 顶层字段
| Field | Type | Sample |
|---|---|---|
| clientToken | string | "7a1bd406-0ca7-4d99-e35f-f53829f29c53" |
...
| Header | Value |
|---|---|
| date | Sun, 24 May 2026 08:06:03 GMT |
| content-type | application/x-amz-json-1.0 |
| content-length | 2 |
| connection | close |
| x-amzn-requestid | ada0f22f-2c16-49e2-bf03-e136c595e862 |
...
---
_原始 JSON_：[`rows/24-POST-q.us-east-1.amazonaws.com_.json`](../rows/24-POST-q.us-east-1.amazonaws.com_.json)
