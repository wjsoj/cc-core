# 26. POST https://client-telemetry.us-east-1.amazonaws.com/metrics

**阶段**：业务 — Telemetry **状态码**：200 **请求大小**：2287 B **响应大小**：0 B
...
- **Content-Type**：`application/json`
- **Content-Length**：`2287` B（解码后实际 `2287` B）
- **格式**：JSON (object)
...
| content-length | 0 |
| connection | close |
| date | Sun, 24 May 2026 08:06:04 GMT |
| x-amzn-trace-id | Root=1-6a12b16c-38d83522792dab0b7d989bfd |
| x-amzn-requestid | 8fbfcf07-26ae-4281-b824-fcc0f99443d7 |
| access-control-allow-origin | * |
| x-amz-apigw-id | d3CpEHfFIAMESIA= |
| x-cache | Miss from cloudfront |
| via | 1.1 e6246845b9eebbec8edbd53525d87f6c.cloudfront.net (CloudFront) |
| x-amz-cf-pop | JFK50-P14 |
| x-amz-cf-id | ZDA4qKm5qCwtVjeqmTGDQdzZpSww7V1ofyo1Krs2BxgBaFwm2PeFmA== |
...
---
_原始 JSON_：[`rows/26-POST-client-telemetry.us-east-1.amazonaws.com_metrics.json`](../rows/26-POST-client-telemetry.us-east-1.amazonaws.com_metrics.json)
