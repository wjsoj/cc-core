# 46. POST https://q.us-east-1.amazonaws.com/

**阶段**：业务 — Turn 11 Telemetry **状态码**：200 **请求大小**：782 B **响应大小**：2 B

**用途**：Turn 11 SendTelemetryEvent。
...
- **Content-Type**：`application/x-amz-json-1.0`
- **Content-Length**：`782` B（解码后实际 `782` B）
- **格式**：JSON (object)

### 顶层字段
| Field | Type | Sample |
|---|---|---|
| clientToken | string | "0051436f-eba0-4f12-c84e-4f4869d423cf" |
...
| Header | Value |
|---|---|
| date | Sun, 24 May 2026 08:07:01 GMT |
| content-type | application/x-amz-json-1.0 |
| content-length | 2 |
| connection | close |
| x-amzn-requestid | 075901c1-9a30-40e8-a329-f7dea8bf5142 |
...
---
_原始 JSON_：[`rows/46-POST-q.us-east-1.amazonaws.com_.json`](../rows/46-POST-q.us-east-1.amazonaws.com_.json)
