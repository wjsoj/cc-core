...
**阶段**：登录前 — Cognito 换 STS **状态码**：200 **请求大小**：63 B **响应大小**：1756 B

**用途**：**Cognito `GetCredentialsForIdentity`**：用上一步的 IdentityId 换 STS 临时凭据（AccessKeyId / SecretKey / SessionToken），用于后续 `client-telemetry.us-east-1` 的 SigV4 签名。
...
| Header | Value |
|---|---|
| date | Sun, 24 May 2026 08:24:37 GMT |
| content-type | application/x-amz-json-1.1 |
| content-length | 1756 |
| connection | close |
| x-amzn-requestid | 6878e79e-645b-4123-a9ab-29e9bf95618a |
