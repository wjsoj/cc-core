...
**阶段**：Telemetry **状态码**：202 **请求大小**：6308 B **响应大小**：2 B
...
- **Content-Type**：`application/json`
- **Content-Length**：`6308` B（解码后实际 `6308` B）
- **格式**：JSON (array[3])
...
| vcs | string | "git" |
| message_i_d | string | "msg_a899b708577f4bf1b88888f2ef8b91c0" |
| tool_name | string | "Bash" |
| is_mcp | bool | false |
| duration_ms | int | 58 |
| pre_tool_hook_duration_ms | int | 0 |
| permission_duration_ms | int | 7 |
| tool_result_size_bytes | int | 845 |
| tool_input_size_bytes | int | 186 |
| file_extension | string | "toml" |
| bash_command_len | int | 129 |
...
| date | Sun, 03 May 2026 15:54:47 GMT |
| connection | close |
