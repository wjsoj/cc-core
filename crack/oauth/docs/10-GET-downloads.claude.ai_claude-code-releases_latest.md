...
**用途**：Claude Code 自更新检测。返回纯文本版本号一行。
...
| Header | Value |
|---|---|
| x-guploader-uploadid | AAVLpEgec9g_uU1YoRA8ZT5LrHz_SXwTQL-vDvyrI-Ci29DX0gHEHW7sx7vO2H9f-td6eOt7 |
...
---
_原始 JSON_：[`rows/10-GET-downloads.claude.ai_claude-code-releases_latest.json`](../rows/10-GET-downloads.claude.ai_claude-code-releases_latest.json)
