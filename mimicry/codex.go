...
// Codex CLI fingerprint, pinned to codex-tui/0.144.4. The identity template
...
// (whistle dump 2026-05-30). Bumped to 0.144.4 (latest stable Codex CLI release
// per github.com/openai/codex as of 2026-07-14 — 0.145 is alpha-only — 0.144.2/.3/.4
// are patch releases with no user-facing/wire changes over 0.144.1). The line still
// exposes the gpt-5.6-{sol,terra,luna} models. The UA/Version format is unchanged
// from 0.135.0 (real 0.144.x UAs are byte-identical modulo the version and the
// OS/terminal segment, which is our synthetic Arch/Konsole identity anyway).
// sub2api pins 0.144.1; 0.144.4 is the same 0.144.x wire format, just the freshest
// version string.
//
...
// backend and what an HTTP-API proxy needs. We mimic the 0.144.4 *identity*
...
const (
	...
	CodexCLIUserAgent = "codex-tui/0.144.4 (Arch Linux Rolling Release; x86_64) Konsole/260401 (codex-tui; 0.144.4)"
