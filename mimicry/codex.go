...
// Codex CLI fingerprint, pinned to codex-tui/0.135.0. Verified against a live
// ChatGPT Pro `codex` (Rust TUI) session capture — see crack/codex/SPEC.md
// (whistle dump 2026-05-30).
//
// Transport note: real codex-tui 0.135.0 streams a turn over a WebSocket
...
// backend and what an HTTP-API proxy needs. We mimic the 0.135.0 *identity*
...
const (
	...
	CodexCLIUserAgent = "codex-tui/0.135.0 (Arch Linux Rolling Release; x86_64) Konsole/260401 (codex-tui; 0.135.0)"
